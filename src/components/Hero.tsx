            ...
            >
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center space-y-3 px-8">
                  ...
                  <p className="text-white/50 text-sm">Hero photography coming soon</p>
                  <p className="text-white/30 text-xs">Lagos creative studio · NIN verified space</p>
                </div>
              </div>
              {/* Vignette overlay */}
            ...
            <div className="absolute bottom-8 -left-4 sm:-left-8 lg:-left-12 animate-slide-in-left delay-600
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-[#8C7B6E] mt-0.5">Tola A. · 2 hrs · ₦50,000</p>
